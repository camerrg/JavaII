...
<c:forEach items= "${requestScope.allItems}" var= "currentitem">
	<option value = "${currentitem.id}">${currentitem.brand} | ${currentitem.color}</option>
</c:forEach>
</select>
<br />
<input type = "submit" value= "Create List and Add Polish">
</form>
<a href = "index.html">Go add new polish.</a> 
</body>
</html>
